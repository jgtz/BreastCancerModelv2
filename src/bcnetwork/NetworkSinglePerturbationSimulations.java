...
public class NetworkSinglePerturbationSimulations {
     ...
     */
        ...
        String outputFileName="BreastCancerSinglePerturbations.txt";
        ...
        for(Integer s0: state1){
                for(int i0=0;i0<nw.getN();i0++){
                    ...
                    line=nw.getNames()[i0]+"="+s0+"\t"+Apofraction1+"\t"+Apofraction2+"\t"+Apofraction3+"\t"+Apofraction+"\t"+Prolfraction1+"\t"+Prolfraction2+"\t"+Prolfraction3+"\t"+Prolfraction4+"\t"+Prolfraction;
